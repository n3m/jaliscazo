    ...
    <>
      ...
      >
        <div className="bg-white border-t border-zinc-200 rounded-t-2xl p-5 pb-8 max-w-lg mx-auto shadow-[0_-4px_30px_rgba(0,0,0,0.1)]">
          ...
          {/* Title */}
          <h2 className="font-display font-bold text-zinc-900 text-xl uppercase tracking-wide mb-1">
          ...
          <div className="flex flex-col gap-4 mb-6">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-display text-base font-bold text-zinc-900 uppercase tracking-wide">
                  Reportar
                </p>
          ...
          <button
            onClick={handleClose}
            className="w-full py-3.5 rounded-xl bg-zinc-900 text-white font-display font-bold text-base tracking-widest uppercase transition-all hover:bg-zinc-800 active:scale-[0.98]"
          >
            Entendido
          </button>
        </div>
